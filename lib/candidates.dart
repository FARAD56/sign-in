...
class _VotesCntState extends State<VotesCnt> {
  ...
  Future getdata() async {
    var rsp = await fetchCandidates(dropdownvalue);
    var data = rsp['data'];
    ...
    filtercandidates = candidates
        .where((candidate) => candidate['position_code'] == dropdownvalue)
        .toList();
  }
  ...
  void _filterData(value) {
    ...
    setState(() {
      filtercandidates = candidates
          .where((candidate) => candidate['position_code'] == value)
          .toList();
    });
  }
                  ...
                  DataCell(
                    ConstrainedBox(
                      ...
                      child: TextField(
                        ...
                        onChanged: (val) {
                          var i = filtercandidates.indexOf(canditate);
                          print(i);
                          if (isNumeric(val)) {
                            setState(() {
